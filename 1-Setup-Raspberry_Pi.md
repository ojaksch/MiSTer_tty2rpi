...
```
sudo apt install mc dos2unix rsync git bc inotify-tools netcat-openbsd flex bison p7zip readline-common ncurses-base xorg xserver-xorg-video-fbdev openbox imagemagick vlc ffmpeg feh
```
